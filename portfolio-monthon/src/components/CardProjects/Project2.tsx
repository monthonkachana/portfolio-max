    ...
    <div>
      <article className="flex flex-col rounded-lg items-center space-y-7 flex-shrink-0 w-[500px] md:w-[600px] xl:w-[900px] snap-center bg-[#292929] p-10 hover:opacity-100 opacity-40 cursor-pointer transition-opacity duration-200 overflow-hidden">
        <motion.img
          ...
          viewport={{ once: true }}
          src="https://scontent.fbkk29-6.fna.fbcdn.net/v/t1.15752-9/328710254_879171139794980_9131257193397366697_n.png?_nc_cat=109&ccb=1-7&_nc_sid=ae9488&_nc_eui2=AeGYOFuk5IvMy3Hikv7WNPqcQcQpA_TdRyJBxCkD9N1HIuLao3kbYf7SFbjbP7zoW5z92_F5v6UaZvIzbXOynhAI&_nc_ohc=wJrMbpEh37oAX8G3CC2&_nc_ht=scontent.fbkk29-6.fna&oh=03_AdR2VuhVNoC_T90XdeOQwNLqqD1DP2wCmwOyuXdL7QESdA&oe=640216A2"
