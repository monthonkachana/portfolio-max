    ...
    <div>
      <article className="flex flex-col rounded-lg items-center space-y-7 flex-shrink-0 w-[500px] md:w-[600px] xl:w-[900px] snap-center bg-[#292929] p-10 hover:opacity-100 opacity-40 cursor-pointer transition-opacity duration-200 overflow-hidden">
        <motion.img
          ...
          viewport={{ once: true }}
          src="https://scontent.fbkk22-3.fna.fbcdn.net/v/t1.15752-9/330031350_752430252681082_7484936432250173702_n.png?_nc_cat=110&ccb=1-7&_nc_sid=ae9488&_nc_eui2=AeFB2ZOZQLeod8BewzIikQNCHDra0EChfzkcOtrQQKF_OVxB5W3QjEjH-xuA5suCq2o_y8DiFHXqH5hM1zA1WDvA&_nc_ohc=aVoq7rus8R8AX-OlK4w&tn=ET5GTkiCYZdXcqNj&_nc_ht=scontent.fbkk22-3.fna&oh=03_AdTqmC200575jpdhZZTHLomieg-xRPwaZYxW2nQ5m00lCw&oe=640ADF0D"
        ...
        <div className="px-0 md:px-10">
          <h4 className="text-4xl font-light">Moive-Web</h4>
          ...
          <p className="uppercase py-5 text-gray-300">
            A front-end developer moive to learn reduxtoolkit a set of tools
            that helps simplify Redux. It includes for creating and managing
            Redux stores &nbsp;&nbsp;
          ...
          <ul className="list-disc space-y-5 ml-5 text-lg">
            <li>WORKSHOP</li>
            <SocialIcon
              url="https://react-moive-test.netlify.app/"
              fgColor="gray"
              bgColor="transparent"
            />
            <SocialIcon
              url="https://github.com/monthonkachana/React-moive-test"
              fgColor="gray"
              bgColor="transparent"
            />
          </ul>
